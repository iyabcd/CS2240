...
app.get('/edit/:teacher_id',(req, res) => {
    ...
    let sql = `Select * from users where id = ${teacher_id}`;
...
app.post('/update',(req, res) => {
    ...
    let sql = "UPDATE teachers SET teacher_lname='"+req.body.teacher_lname+"',  teacher_fname='"+req.body.teacher_fname+"',  teacher_mname='"+req.body.teacher_mname+"' where id ="+ teacher_id;
