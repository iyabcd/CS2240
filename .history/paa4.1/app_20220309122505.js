...
app.post('/subjects/save',(req, res) => { 
    let data = {subject_id: req.body.subject_id, subject_name: req.body.subject_name, subject_no: req.body.subject_no, 
        transcript_load: req.body.transcript_load, paying_load: req.body.paying_load};
