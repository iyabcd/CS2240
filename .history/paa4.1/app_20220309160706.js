...
app.post('/subjects/save', [
    ...
    if(!errors.isEmpty()){
        const alert = errors.array();
        req.flash('message', 'Input must be LETTERS only for TITLE, LETTERS AND NUMBERS for NUMBER, and NUMBERS ONLY for LOADS.');
        req.flash('message', 'Fields should not be empty.');
