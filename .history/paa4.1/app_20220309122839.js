...
app.post('/subjects/update',(req, res) => {
    ...
    let sql = "UPDATE subjects SET subject_title='"+req.body.subject_title+"',  subject_fname='"+req.body.subject_fname+"',  subject_mname='"+req.body.subject_mname+"' WHERE subject_id ="+ subject_id;
    let query = connection.query(sql,(err, results) => {
      if(err) throw err;
      res.redirect('/subjects');
    });
