...
app.post('/update',(req, res) => {
    ...
    let sql = "UPDATE TEACHERS SET teacher_lname='"+req.body.teacher_lname+"',  teacher_fname='"+req.body.teacher_lname+"',  phone_no='"+req.body.phone_no+"' WHERE teacher_id ="+ teacher_id;
