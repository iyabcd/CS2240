...
app.post('/update',(req, res) => {
    ...
    let sql = "UPDATE TEACHERS SET teacher_lname='"+req.body.teacher_lname+"',  teacher_fname='"+req.body.teacher_fname+"',  teacher_mname='"+req.body.teacher_lname+"' WHERE teacher_id ="+ teacher_id;
