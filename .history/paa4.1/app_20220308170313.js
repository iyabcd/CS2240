...
//update teacher
// app.get('/teachers/edit/:teacher_id',(req, res) => {
...
app.post('/teachers/update',(req, res) => {
    ...
    let sql1 = `SELECT * FROM teachers WHERE teacher_id = ${teacher_id}`;
    let sql2 = "UPDATE TEACHERS SET teacher_lname='"+req.body.teacher_lname+"',  teacher_fname='"+req.body.teacher_fname+"',  teacher_mname='"+req.body.teacher_mname+"' WHERE teacher_id ="+ teacher_id;
    let query = connection.query(sql1, sql2,(err, results) => {
      if(err) throw err;
      res.redirect('/');
    });
});
