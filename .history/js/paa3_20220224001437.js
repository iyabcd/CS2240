var size = ['990px',window.height];  //public variable
...
function labelScroll() {
  ...
  $(window).scroll(function() {
    ...
    if(a >= '190px' && a < '260px'){
      ...
      $('.about .section-content').css("opacity", "0" );
      $('.services .section-content').css("opacity", "0" );
      $('.contact .section-content').css("opacity", "0" );
    }
  });
}
function welcome() {
